...
class vgg16(nn.Module):
    ...
    def __init__(self, mode='rgb'):
        ...
        pre_train = torch.load('./backbone/pretrained/vgg16-397923af.pth')
...
class vgg_DAF(nn.Module):
    # block - pooling
    def __init__(self, mode='rgb'):
        super(vgg_DAF, self).__init__()
        ...
        conv1.add_module('bn1_2', nn.BatchNorm2d(64))
        conv1.add_module('relu1_2', nn.ReLU(inplace=True))
        conv1.add_module('pool1', nn.MaxPool2d(2, stride=2))
        self.conv1 = conv1
        ...
        conv2.add_module('bn2_2', nn.BatchNorm2d(128))
        conv2.add_module('relu2_2', nn.ReLU())
        conv2.add_module('pool2', nn.MaxPool2d(2, stride=2))
        self.conv2 = conv2
        ...
        conv3.add_module('bn3_3', nn.BatchNorm2d(256))
        conv3.add_module('relu3_3', nn.ReLU())
        conv3.add_module('pool3_1', nn.MaxPool2d(2, stride=2))
        self.conv3 = conv3
        ...
        conv4.add_module('bn4_3', nn.BatchNorm2d(512))
        conv4.add_module('relu4_3', nn.ReLU())
        conv4.add_module('pool4', nn.MaxPool2d(2, stride=2))
        self.conv4 = conv4
